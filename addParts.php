    ...
    <main class="container">
      <?php if ( isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] == true ) :?>
        <div class="row justify-content-center">
          <form id="add_form" class="col-md-8 col-xl-6 mb-4" enctype="multipart/form-data" action="addPartsConfirmation.php" method="POST">
            <div class="mb-3">
              <label for="part" class="form-label">Part</label>
              <select class="form-select" name="part" id="part">
                <option value="1" <?php if (isset($_GET['id']) && $_GET['id'] == 1):?>selected <?php endif;?>>CPU</option>
                <option value="2" <?php if (isset($_GET['id']) && $_GET['id'] == 2):?>selected <?php endif;?>>CPU Cooler</option>
                <option value="3" <?php if (isset($_GET['id']) && $_GET['id'] == 3):?>selected <?php endif;?>>Motherboard</option>
                <option value="4" <?php if (isset($_GET['id']) && $_GET['id'] == 4):?>selected <?php endif;?>>Memory</option>
                <option value="5" <?php if (isset($_GET['id']) && $_GET['id'] == 5):?>selected <?php endif;?>>Storage</option>
                <option value="6" <?php if (isset($_GET['id']) && $_GET['id'] == 6):?>selected <?php endif;?>>Video Card</option>
                <option value="7" <?php if (isset($_GET['id']) && $_GET['id'] == 7):?>selected <?php endif;?>>Power Supply</option>
                <option value="8" <?php if (isset($_GET['id']) && $_GET['id'] == 8):?>selected <?php endif;?>>Case</option>
              </select>
            </div>
            <div class="mb-3" id="name_group">
              <label for="name" class="form-label">Name</label>
              <input type="text" class="form-control" id="name" name="name" 
                  <?php if ( (isset($_GET['id']) && $_GET['id'] == 1) || !isset($_GET['id'])):?>
                  ...
                  <?php endif;?>
                  <?php if (isset($_GET['id']) && $_GET['id'] == 6):?>
                    placeholder="Example: EVGA GeForce RTX 3090"
                  <?php endif;?>
                  <?php if (isset($_GET['id']) && $_GET['id'] == 7):?>
                    placeholder="Example: SeaSonic FOCUS 850 W"
                  <?php endif;?>
                  <?php if (isset($_GET['id']) && $_GET['id'] == 8):?>
      ...
      <?php else:?>
        <div class='text-center no-login'>
          ...
          <h2 class='my-3'>Please Log In To Add Parts</h2>
