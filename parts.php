                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <?php if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn'] == true) : ?>
                                    <a href="partEdit.php?part_id=<?php echo $row['id'];?>&id=<?php echo $_GET['id']?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    <a onclick="return confirm('Are you sure to delete?')" href="partDeleteConfirmation.php?part_id=<?php echo $row['id'];?>&id=<?php echo $_GET['id']?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                                <?php endif;?>
                            </div>
                        </td>
                    </tr>
